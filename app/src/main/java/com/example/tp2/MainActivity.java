    ...
    protected void onStart() {
        ...
        btnWeb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Uri webPage = Uri.parse("https://www.android.com"); // METTRE L'uri
        ...
        btnPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Intent => lance une activité Call
            }
        });
        ...
        btnMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // le type de l'email
                emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"nesrineissac@gmail.com","shaieknesrine01@gmail.com"});
                emailIntent.putExtra(Intent.EXTRA_SUBJECT,"email subject");
                emailIntent.putExtra(Intent.EXTRA_TEXT,"email message text");
                // putExtra ajouter plus sur l'activités
